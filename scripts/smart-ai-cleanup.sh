...
cat > "$CLAUDE_SETTINGS_DIR/settings.json" << 'EOF'
{
  "permissions": {
    "allow": [
      ...
      "Bash(go clean*)",
      "Bash(pip cache*)",
      "Bash(python3 -m pip cache*)",
      "Bash(find * -name .next -delete)",
      "Bash(find * -name node_modules -delete)",
      "Bash(find * -name target -delete)",
      "Bash(find * -name __pycache__ -delete)",
      "Bash(find * -name vendor -delete)",
      "Bash(find * -name build -delete)",
      "Bash(find * -name dist -delete)",
      "Bash(rm -rf ~/Library/Caches/*)",
      "Bash(rm -rf ~/Library/Application\\ Support/*/cache*)",
      "Bash(rm -rf ~/Library/Application\\ Support/*Cache*)",
      "Bash(rm -rf ~/.bun/cache)",
      "Bash(rm -f */*.log)",
      "Bash(du *)",
      "Bash(df *)",
      "Read",
